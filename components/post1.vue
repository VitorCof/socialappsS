      ...
      <div class="flex items-center w-full">
        <div class="w-full">
          <div class="flex flex-row mt-2 px-2 py-3 mx-3">
            <div class="w-auto h-auto rounded-full border-2 border-pink-500">
              <img
                ...
                "
                alt="User avatar"
                src="https://www.nerdediva.com.br/wp-content/uploads/2018/11/playstation-logo.jpg"
              />
            </div>
            <div class="flex flex-col mb-2 ml-4 mt-1">
              <div class="text-gray-600 text-sm font-semibold">Playstation</div>
              <div class="flex w-full mt-1">
                <div
                  class="text-blue-700 font-base text-xs mr-1 cursor-pointer"
                >
                  Fabricante de videogames e jogos.
                </div>
          ...
          <div class="text-gray-400 font-medium text-sm mb-7 mt-6 mx-3 px-2">
            <img class="rounded" src="https://1.bp.blogspot.com/-EEeSRpUuYmQ/XuLnaVAvHJI/AAAAAAAAWBw/GFJzSGtnI4Q8uidPhbdcti36kx-JE-5FgCLcBGAsYHQ/s1600/CAPA.png" />
          </div>
          <div class="text-gray-600 font-semibold text-lg mb-2 mx-3 px-2">
            Como a Naughty Dog ajustou a guitarra jogável de Ellie em The Last of Us Parte II: http://play.st/3rkI0F3
          </div>
          <div class="text-gray-500 font-thin text-sm mb-6 mx-3 px-2">
            Disponível com PlayStation Now
          </div>
