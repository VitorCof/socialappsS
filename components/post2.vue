      ...
      <div class="flex items-center w-full">
        <div class="w-full">
          <div class="flex flex-row mt-2 px-2 py-3 mx-3">
            <div class="w-auto h-auto rounded-full border-2 border-pink-500">
              <img
                ...
                "
                alt="User avatar"
                src="https://pbs.twimg.com/profile_images/1404140852960661504/g7-9UtAI_400x400.jpg"
              />
            </div>
            <div class="flex flex-col mb-2 ml-4 mt-1">
              <div class="text-gray-600 text-sm font-semibold">Forza Horizon</div>
          ...
          <div class="text-gray-400 font-medium text-sm mb-7 mt-6 mx-3 px-2">
            <img
              class="rounded"
              src="https://pbs.twimg.com/media/FEhNO8WXEAIsp20?format=jpg&name=small"
            />
          </div>
          <div class="text-gray-600 font-semibold text-lg mb-2 mx-3 px-2">
            Obrigado aos mais de 10 milhões de fãs de # ForzaHorizon5 pela maior primeira semana em
                       @Xbox
                        história e
                        @XboxGamePass
                        SEMPRE. GG
          ...
          <div class="text-gray-500 font-thin text-sm mb-6 mx-3 px-2">
            Obrigado a todos com carinho da Playgroudgames.
          </div>
